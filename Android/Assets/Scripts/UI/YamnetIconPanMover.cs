...
public class YamnetIconPanMover : MonoBehaviour
{
    [Header("Target UI")]
    public RectTransform target; // YamnetIcon rect

    [Header("Movement")]
    [Tooltip("Max horizontal movement in pixels at pan=±1.")]
    ...
    /// <summary>
    /// Call this continuously (e.g., each audio chunk).
    /// pan: -1..+1 (left..right)
    ...
    private void Update()
    {
        ...
        // Smooth follow
        target.anchoredPosition = Vector2.Lerp(cur, desired, 1f - Mathf.Exp(-followSpeed * Time.deltaTime));
    }
}
